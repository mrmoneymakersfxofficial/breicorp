...
/** Logo mark variant for dark backgrounds (white B on orange) */
export function LogoMarkLight({
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="breicorp-orange-light" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF8A3D" />
          <stop offset="1" stopColor="#FF6801" />
        </linearGradient>
      </defs>
      <rect x="2" y="2" width="60" height="60" rx="16" fill="url(#breicorp-orange-light)" />
      <path
        d="M22 18h12.5c5.8 0 9.5 2.6 9.5 7.2 0 3.1-1.7 5.1-4.4 6.1 3.4.9 5.4 3.1 5.4 6.7 0 5-4 7.9-10.3 7.9H22V18Zm6.2 10.6h5.4c2.3 0 3.7-.9 3.7-2.6 0-1.7-1.4-2.5-3.7-2.5h-5.4v5.1Zm0 11.1h5.9c2.5 0 4-1 4-2.9 0-1.9-1.5-2.9-4-2.9h-5.9v5.8Z"
        fill="#ffffff"
      />
